...
<main class="competicoes">
  <section class="intro">
    <h1>Compeonatos Atuais</h1>
    <p>Acompanhe os campeonatos e torneios que a <strong>The Last Hope Esports</strong> está disputando.</p>
  </section>

  <section class="grid-competicoes">

    <!-- Card exemplo -->
    <h2>A equipe não está ativa em nenhum torneio ou campeonato atual.</h2>
